...
def paths_to_gcode(
    ...
    path_heights: Optional[Sequence[Optional[float]]] = None,
) -> List[str]:
    gcode: List[str] = []
    ...
    for index, path in enumerate(paths):
        ...
        target_height = settings.drawing_height
        if path_heights is not None and index < len(path_heights):
            override = path_heights[index]
            if override is not None:
                target_height = override
